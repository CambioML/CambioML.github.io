export const no = {
      ...
      steps: [
        {
          ...
          description:
            "Klikk 'Last opp fil' for enkelt å dra og slippe dokumentene du vil parse, eller bare lim inn et skjermbilde fra utklippstavlen. Vi har også gitt eksempeldokumentasjon for å hjelpe deg i gang.",
        },
        {
          title: '02',
          subtitle: 'Rediger parsing- og personverninnstillinger',
          description:
            'AnyParser kategoriserer automatisk ulike typer informasjon, inkludert PII (Personlig Identifiserbar Informasjon), fotnoter, tabeller og mer. Bare eksporter dataene du trenger!',
        },
        {
          title: '03',
          subtitle: 'Eksporter resultater til systemet ditt',
          description:
            'Last ned dataene dine i ønsket format—enten det er HTML, Excel, JSON eller et databaseskjema tilpasset din forretningsarbeidsflyt.',
        },
      ],
    },
    banners: [
  ...
  pricing: {
    ...
    disclaimers: {
      ...
      tokenExplanation:
        '** Sider som overstiger 500 tokens vil medføre en ekstra kreditt for hver ytterligere 500 tokens.',
    },
    specialOffer: {
