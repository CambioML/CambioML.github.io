export const fi = {
  ...
  homepage: {
    hero: {
      ...
      description: '80 % OCR-käyttäjistä on kyllästynyt ylläpitämään liimakoodia. Vapauta aikaasi vertaansa vailla olevalla tarkkuudella, täydellä yksityisyydellä ja mukautettavilla vaihtoehdoilla, kuten:',
      features: [
    ...
    howItWorks: {
      title: 'Kuinka AnyParser toimii',
      subtitle: 'Jäsennä mitä tahansa dataa mistä tahansa dokumentista yksinkertaisella käyttöliittymällä',
      tryFree: 'Kokeile ILMAISEKSI',
      steps: [
        {
          title: '01',
          subtitle: 'Vedä ja pudota dokumentit',
          description: 'Klikkaa \'Lataa tiedosto\' ja vedä helposti dokumentit, jotka haluat jäsentää, tai liitä kuvakaappaus suoraan leikepöydältäsi. Olemme myös tarjonneet esimerkkidokumentaatiota, jotta pääset alkuun.'
        },
        {
          title: '02',
          subtitle: 'Muokkaa jäsentämis- ja yksityisyysasetuksia',
          description: 'AnyParser luokittelee automaattisesti erilaisia tietotyyppejä, mukaan lukien PII (henkilökohtaisesti tunnistettavat tiedot), alaviitteet, taulukot ja paljon muuta. Vie vain tarvitsemasi data!'
        },
        {
          title: '03',
          subtitle: 'Vie tulokset järjestelmääsi',
          description: 'Lataa datasi haluamassasi muodossa—olipa se HTML, Excel, JSON tai liiketoimintatyönkulkuusi räätälöity tietokantaskeema.'
        }
      ]
    },
    banners: [
      {
        ...
        description: 'AnyParser-leikkikenttä on yksinkertainen, nopea ja intuitiivinen. Kokeile käyttöliittymää nyt ja pidä tauko loppupäivän ajan',
        actionLabel: 'Kokeile ILMAISEKSI'
      },
      {
        title: 'Rakenna AnyParserilla',
        description: 'AnyParser-leikkikenttä on yksinkertainen, nopea ja todella intuitiivinen, kokeile käyttöliittymää nyt ja pidä tauko loppupäivän ajan',
  ...
  reviews: {
    ...
    testimonials: [
      ...
      {
        text: '"Se on paljon parempi kuin muut työkalut! Data-analyytikkomme pystyvät kolminkertaistamaan tuotoksensa."',
        author: 'Jamal',
        position: 'Toimitusjohtaja - xtrategise'
      }
    ]
  },
  company: {
    ...
    getStarted: {
      ...
      description: 'Liity tuhansien tutkijoiden ja insinöörien joukkoon, jotka nopeuttavat tutkimus- ja kehitysprosessejaan Energent.ai:n avulla.',
      buttonText: 'Aloita',
      docsButtonText: 'Lue dokumentaatio'
    }
  },
  pricing: {
    billing: {
    ...
    plans: {
      ...
      silver: {
        ...
        monthlyPrice: '1500',
        annualPrice: '15000',
        description: 'Tiimeille, jotka haluavat laajentaa dokumenttien käsittelyä parannetulla tuella ja ominaisuuksilla.',
        features: [
      ...
      gold: {
        ...
        monthlyPrice: '4500',
        annualPrice: '45000',
        description: 'Suuryrityksille, jotka tarvitsevat edistyneitä ominaisuuksia, yksityistä hostingia ja ensiluokkaista tukea.',
        features: [
      ...
      enterprise: {
        name: 'Yritys',
        price: 'Ota yhteyttä',
        description: 'Suurille organisaatioille, jotka tarvitsevat räätälöityjä ratkaisuja, omistettua tukea ja yritystason turvallisuutta.',
        features: [
    ...
    disclaimers: {
      ...
      tokenExplanation: '** Sivut, jotka ylittävät 500 tokenia, aiheuttavat lisäluoton jokaista ylimääräistä 500 tokenia kohden.'
    },
    specialOffer: {
      ...
      redeemText: 'lunastaaksesi luottosi!'
    }
  },
  playground: {
    title: 'AnyParser Sandbox',
    description: 'Ensimmäinen LLM, joka nopeasti ja tarkasti poimii koko sisällön PDF-tiedostoista*, PPT-tiedostoista ja kuvista**.',
    tabs: {
    ...
    disclaimers: {
      pageLimit: '*Jokaisen ladatun tiedoston osalta käsittelemme vain ensimmäiset kymmenen sivua paremman saatavuuden vuoksi.',
      fileSize: '**MAKSIMITIEDOSTOKOKO ON 10MB. Tämän sivun päivittäminen tyhjentää kaikki tiedostot ja käsitellyt tiedot, koska emme tallenna tietojasi.',
      privacyPolicy: 'Katso AnyParserin tietosuojakäytäntö.'
    },
    feedback: {
      button: 'Palaute',
      title: 'Sandbox-palaute',
      nameLabel: 'Nimi',
      emailLabel: 'Sähköposti',
      messageLabel: 'Viesti',
      submitButton: 'Lähetä',
      successMessage: 'Lähetetty!',
      errorMessage: 'Yhteydenotto epäonnistui. Yritä uudelleen.'
    },
    files: {
      title: 'Tiedostot',
    ...
    upload: {
      dragAndDrop: 'Vedä ja pudota yksi tiedosto tähän tai napsauta valitaksesi tiedoston',
    ...
    uploadModal: {
      or: 'TAI',
      pasteScreenshot: 'Liitä kuvakaappaus',
      uploading: 'Ladataan'
    },
    keyValue: {
      keyNamePlaceholder: 'Avainnimi',
      keyDescriptionPlaceholder: '(Valinnainen) Määrittele avaimet parantaaksesi AnyParserin tarkkuutta',
      keyNameRequired: 'Avainnimi on pakollinen',
      ...
      undo: 'Kumoa',
      maxInputsAllowed: 'Enintään 10 syötettä sallittu',
    ...
    info: {
      plainText: {
        ...
        howTo: 'Kun olet ladannut ja valinnut tiedoston, suorita \'Koko sisältö\' -toiminto, joka poimii tiedostosi sisällön ja palauttaa sen Markdown-muodossa.',
        nextSteps: 'Seuraavat askeleet',
        nextStepsDescription: 'Voit ladata raakamuotoisen Markdownin tekstinä tai ladata JSONin kaikista poimituista taulukoista'
      },
      table: {
        title: 'Vain taulukon poiminta',
        description: 'AnyParserilla voit poimia taulukoita tiedostoistasi, poimia niistä tiettyjä avaimia ja kartoittaa ne tietokantasi skeemaan.',
        step1: '1. Poimi taulukot',
        step1Description: 'Ensiksi sinun tulee poimia taulukot tiedostostasi. AnyParser poimii kaikki taulukot HTML-muotoon.\n\nKun taulukot on poimittu, voit ladata raakamuotoisen HTML:n tai ladata kaikki taulukot Excel-tiedostoon.',
        step2: '2. Valitse taulukot kartoitettavaksi',
        step2Description: 'Kun olet suorittanut taulukon poiminnan, valitse taulukot, joista haluat poimia tietoja.\n\nTässä osiossa voit myös esikatsella kunkin taulukon HTML-muotoa.',
        step3: '3. Kartoitusskeema',
        step3Description: 'Kun olet poiminut ja valinnut taulukot, voit sitten lisätä avaimet, jotka haluat poimia. Jos haluat poistaa kartoitettua avainta, napsauta laatikon (X)-kuvaketta. Jos haluat poistaa syöteavaimen, voit napsauttaa sen laatikon (X)-kuvaketta.\n\nKun olet lisännyt joitakin avaimia, voit suorittaa Kartoitusskeema-toiminnon. Kartoituksen jälkeen voit muokata mitä tahansa kartoitettuja avaimia napsauttamalla muokkauskynäkuvaketta.\n\nNapsauttamalla \'Kartoitusskeema\' uudelleen suoritetaan vain syöteavaimet ilman kartoitettuja avaimia. Jos haluat luoda uuden kartoitettavan avaimen, voit ensin poistaa kartoitettua avainta napsauttamalla X.',
        nextSteps: 'Seuraavat askeleet',
        nextStepsDescription: 'Kun olet tyytyväinen tulokseen, voit ladata CSV:n tai JSONin. Tämä on käytettävissä vain, jos vähintään yhdellä syöteavaimella on ei-tyhjä kartoitettu avain.'
      },
      keyValuePair: {
        title: 'Poimi avain-arvo -parit',
        description: 'AnyParserilla voit tunnistaa ja poimia rakenteellisia avain-arvo -pareja raakadatastasi, kuten laskuista, sopimuksista tai lomakkeista.',
        howTo: 'Kun olet ladannut ja valinnut tiedoston, suorita \'Avain-arvo -pari\' -toiminto, joka analysoi tiedostosi, tunnistaa avainkentät ja poimii niiden vastaavat arvot rakenteellisessa JSON-muodossa.',
        nextSteps: 'Seuraavat askeleet',
        nextStepsDescription: 'Voit ladata poimitut avain-arvo -parit JSON-tiedostona tai integroida suoraan työnkulkuusi API:n kautta automatisoidaksesi jatkokäsittelyn.'
      }
    },
  ...
  solutionPages: {
    compliance: {
      ...
      section: {
        ...
        paragraph: 'Oletko huolissasi vaatimustenmukaisuudesta tai riskistä yksityisille LLM:illesi? Tarjoamme erikoistuneen vaatimustenmukaisuus-LLM:n sääntelyvaatimustenmukaisuuteen ja riskienhallintaan. Tämä järjestelmä seuraa automaattisesti sääntelymuutoksia ja sovittaa ne sisäisiin käytäntöihisi ja valvontasi, varmistaen merkittävien säädösten ja vaatimusten oikea-aikaisen seurannan, reagoinnin ja raportoinnin.'
      },
      useCases: [
        {
      ...
      autorater: {
        ...
        section: {
          ...
          paragraph: 'Oletko huolissasi AutoRaterista tai riskistä yksityisille LLM:illesi? Tarjoamme erikoistuneen AutoRater-LLM:n sääntelyyn ja riskienhallintaan. Tämä järjestelmä seuraa automaattisesti sääntelymuutoksia ja sovittaa ne sisäisiin käytäntöihisi ja valvontasi, varmistaen merkittävien säädösten ja vaatimusten oikea-aikaisen seurannan, reagoinnin ja raportoinnin.'
        }
      }
    },
    finance: {
      title: 'Räätälöity AI-avustajasi löytämään oivalluksia',
      description: 'Löydä väärin hinnoiteltu osake nopeammin.\nPerustele sijoituspäätöksesi todellisilla tiedoilla.\nOmista ja hallitse täysin oma AI-agenttisi.',
      iconSection: {
  ...
  footer: {
    ...
    resources: {
      title: 'Resurssit',
      anyParserDocs: 'AnyParser-dokumentaatio',
  ...
  account: {
    ...
    profile: {
      title: 'Profiili',
      errorLoading: 'Virhe käyttäjäprofiilin lataamisessa',
      pleaseLogin: 'Kirjaudu sisään.',
      welcome: 'Tervetuloa'
    },
    apiKey: {
      title: 'AnyParser API-avain',
      gettingStarted: 'Aloittaminen AnyParserin kanssa',
      ...
      generateNew: 'Luo uusi API-avain',
      generating: 'Luodaan...'
    },
    subscriptions: {
      title: 'Tilaukset',
      description: 'Näytä tuotteet tai muokkaa tilaustasi.',
      viewProducts: 'Näytä tuotteet'
    },
    documentation: 'Tutustu AnyParser-dokumentaatioon'
  },
  auth: {
