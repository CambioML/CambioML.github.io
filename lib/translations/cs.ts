export const cs = {
  nav: {
    ...
    docs: 'Dokumentace',
    aboutUs: 'O nás',
    trySandbox: 'Vyzkoušejte Sandbox',
    getApiKey: 'Získejte API klíč',
    aiOgSpecialist: 'AI O&G Specialista',
    aiOgDescription: 'Zlepšuje pracovní postupy mezi terénem a kanceláří.',
    aiHr: 'AI HR',
    aiHrDescription: 'Řeší opakující se pracovní postupy HR.',
    aiDataScientist: 'AI Datový vědec',
    aiDataDescription: 'Zrychluje datové pracovní postupy ve velkém měřítku',
    securityWhitepaper: 'Bezpečnostní dokument',
    securityDescription: 'Komplexní průvodce bezpečností a dodržováním předpisů.',
    deploymentOverview: 'Přehled nasazení',
    deploymentDescription: 'Požadavky na podnikové nasazení.',
  ...
  homepage: {
    ...
    howItWorks: {
      ...
      subtitle: 'Zpracujte jakákoli data z jakýchkoli dokumentů s přímým uživatelským rozhraním',
      tryFree: 'Vyzkoušejte ZDARMA',
      steps: [
        {
          title: '01',
  ...
  pricing: {
    ...
    plans: {
      starter: {
        ...
        monthlyPrice: '499',
        annualPrice: '5000',
        description: 'Pro firmy, které chtějí začít s zpracováním dokumentů v reálném čase a extrakcí dat.',
        features: [
          'Extrahujte celý text do Markdownu nebo extrahujte tabulky z PDF/obrázku do CSV',
          '20k kreditů měsíčně, poté $0.025 za kredit',
      ...
      silver: {
        ...
        monthlyPrice: '1500',
        annualPrice: '15000',
        description: 'Pro týmy, které chtějí rozšířit zpracování dokumentů s vylepšenou podporou a funkcemi.',
        features: [
          'Všechny funkce Startovní',
          '100k kreditů měsíčně, poté $0.015 za kredit',
      ...
      gold: {
        ...
        monthlyPrice: '4500',
        annualPrice: '45000',
        description: 'Pro podniky, které potřebují pokročilé funkce, soukromé hostování a prémiovou podporu.',
        features: [
          'Všechny funkce Stříbrný',
          '500k kreditů měsíčně, poté $0.009 za kredit',
          'Soukromé hostování modelu (na místě nebo v cloudu)',
    ...
    specialOffer: {
      ...
      getStart: 'Získejte',
      highlight: '3 měsíce ZDARMA',
      forText: 'pro startupy',
      startupDetails: '(méně než 10 lidí)',
      orText: 'nebo',
  ...
  playground: {
    ...
    description: 'První LLM, který rychle a přesně extrahuje celý obsah z PDF*, PPT a obrázků**.',
    tabs: {
    ...
    keyValue: {
      ...
      keyDescriptionPlaceholder: '(Volitelné) Definujte klíče pro zlepšení přesnosti AnyParseru',
      keyNameRequired: 'Název klíče je povinný',
      addKeyValuePair: 'Přidat klíč-hodnotový pár',
      removeKeyValuePair: 'Odstranit klíč-hodnotový pár',
      expandKeyDescription: 'Rozšířit popis klíče',
      extract: 'Extrahovat',
      extracting: 'Extrahování...',
      extractKeyValue: 'Extrahovat klíč-hodnotu',
      extractKeyValuePairs: 'Extrahovat klíč-hodnotové páry',
      yourKeys: 'Vaše klíče',
      inputRemoved: 'Vstup odstraněn',
      undo: 'Zpět',
  ...
  account: {
    ...
    apiKey: {
      ...
      gettingStarted: 'Začínáme s AnyParser',
      limitedTime: 'Omezený čas!',
      freePages: 'Každé API může zdarma extrahovat až 100 stránek!',
      note: 'Poznámka:',
      limitations: [
  ...
  bookDemo: {
    ...
    pageTitle: '🗓️ Rezervovat demo',
    pageDescription: 'Ukážeme vám, jak maximalizovat extrakci dat',
    formTitle: 'Formulář žádosti o demo',
    submitted: {
  ...
  messages: {
    success: {
      sent: 'Odesláno!',
      subscriptionSuccessful: 'Předplatné bylo úspěšné!',
      apiKeyCopied: 'API klíč zkopírován do schránky!',
      verificationResent: 'Ověřovací e-mail znovu odeslán!',
      fileUploaded: 'Soubor(y) úspěšně nahrány!',
      resultCopied: 'Výsledek zkopírován do schránky',
      extractionComplete: 'Extrakce dokončena!',
      newInputAdded: 'Nový vstup přidán',
      removeUndone: 'Odstranění vráceno zpět',
      generatingFor: 'Generování souhrnů pro',
      summariesGenerated: 'Souhrny vygenerovány pro',
      downloadingSummaries: 'Stahování souhrnů pro',
    ...
    error: {
      ...
      pleaseSignIn: 'Prosím, přihlaste se, abyste mohli spravovat své předplatné',
      errorFetchingApiKeys: 'Chyba při získávání API klíčů',
      errorResendingEmail: 'Chyba při opětovném odesílání ověřovacího e-mailu',
      failedAccessToken: 'Nepodařilo se získat přístupový token',
      fileTypeNotSupported: 'Typ souboru není podporován.',
      maxFileSize: 'Maximální velikost souboru je 10 MB.',
      loadingStarterFile: 'Chyba při načítání startovacího souboru. Zkuste to prosím znovu.',
      undefinedResult: 'Obdržel se nedefinovaný výsledek. Zkuste to prosím znovu.',
      parameterInvalid: 'Parametr je neplatný. Zkuste to prosím znovu.',
      jobNotFound: 'Úloha nebyla nalezena. Zkuste to prosím znovu.',
      pageLimitReached: 'Byl dosažen limit stránek pro extrakci.',
      jobFailed: 'Úloha selhala. Zkuste to prosím znovu.',
      extractionError: 'Chyba při extrakci. Zkuste to prosím znovu.',
      requestTimeout: 'Časový limit požadavku vypršel. Zkuste to prosím znovu.',
      invalidModelType: 'Neplatný typ modelu. Zkuste to prosím znovu.',
      uploadError: 'Chyba při nahrávání. Zkuste to prosím znovu.',
      noTablesFound: 'Nebyly nalezeny žádné tabulky k exportu do Excelu',
      noValidTables: 'Nebyly nalezeny žádné platné tabulky k exportu do Excelu',
      maxInputsReached: 'Maximálně 10 vstupů povoleno',
      extractLimitReached: 'Byl dosažen limit extrakce.',
      extractionFailed: 'Extrakce selhala. Zkuste to prosím znovu.',
      errorDuringExtraction: 'Chyba během extrakce. Zkuste to prosím znovu.',
      selectFileFirst: 'Prosím, nejprve vyberte soubor',
      noFileSelected: 'Žádný soubor nebyl vybrán',
      missingFormData: 'Chybí formData. Zkuste to prosím znovu.',
