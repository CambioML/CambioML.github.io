export const da = {
  nav: {
    ...
    aiOgDescription: 'Forbedrer arbejdsprocesser fra felt til kontor.',
    aiHr: 'AI HR',
    aiHrDescription: 'Håndterer repetitive HR-arbejdsprocesser.',
    aiDataScientist: 'AI Data Scientist',
    aiDataDescription: 'Accelererer dataarbejdsprocesser i stor skala',
    securityWhitepaper: 'Sikkerhedshvidbog',
    securityDescription: 'Omfattende vejledning om sikkerhed og overholdelse.',
    deploymentOverview: 'Implementeringsoversigt',
    deploymentDescription: 'Krav til virksomhedsimplementering.',
    awsDeployment: 'AWS Implementering',
    awsDescription: 'AWS VM implementeringsvejledning.',
    azureDeployment: 'Azure Implementering',
    azureDescription: 'Azure VM implementeringsvejledning.'
  },
  common: {
    language: 'Sprog',
    english: 'Engelsk',
  ...
  homepage: {
    hero: {
      ...
      description: '80% af OCR-brugere er trætte af at vedligeholde limkode. Frigør din tid med uovertruffen nøjagtighed, fuld fortrolighed og konfigurerbare muligheder såsom:',
      features: [
        'fjernelse af private identitetsoplysninger,',
        'udtrækning af tabeller og diagrammer,',
        'bevaring af fodnoter og overskrifter,'
      ],
      moreFeatures: 'og meget mere!',
      tryFree: 'Prøv GRATIS',
      ...
      steps: [
        {
          ...
          description: 'Klik på \'Upload fil\' for nemt at trække og slippe de dokumenter, du vil parse, eller indsæt blot et skærmbillede fra dit udklipsholder. Vi har også leveret eksempeldokumentation for at hjælpe dig i gang.'
        },
        {
          title: '02',
          subtitle: 'Rediger parsing- og fortrolighedsindstillinger',
          description: 'AnyParser kategoriserer automatisk forskellige typer information, herunder PII (Personligt Identificerbare Oplysninger), fodnoter, tabeller og mere. Eksporter blot de data, du har brug for!'
        },
        {
          title: '03',
          subtitle: 'Eksporter resultater til dit system',
          description: 'Download dine data i dit foretrukne format—uanset om det er HTML, Excel, JSON eller en databaseskema skræddersyet til din virksomheds arbejdsproces.'
        }
      ]
    },
    banners: [
      {
        ...
        description: 'AnyParser legeplads er ligetil, hurtig og intuitiv. Prøv grænsefladen nu og tag en pause resten af dagen',
        actionLabel: 'Prøv GRATIS'
      },
      {
        title: 'Byg med AnyParser',
        description: 'AnyParser legeplads er ligetil, hurtig, virkelig intuitiv, prøv grænsefladen nu og tag en pause resten af dagen',
  ...
  reviews: {
    ...
    testimonials: [
      ...
      {
        text: '"AnyParser\'s avancerede multimodale AI leverer, hvor andre tilgange fejler. Komplekse dokumenter kræver denne fusion af syn og sprog."',
        author: 'Jon Conradt',
      ...
      {
        text: '"Det er langt bedre end andre værktøjer! Vores dataanalytikere er i stand til at tredoble deres output."',
        author: 'Jamal',
  ...
  company: {
    ...
    getStarted: {
      ...
      description: 'Slut dig til tusindvis af forskere og ingeniører, der fremskynder deres F&U-processer med Energent.ai.',
      buttonText: 'Kom i gang',
      docsButtonText: 'Læs dokumentationen'
    }
  },
  pricing: {
    billing: {
    ...
    plans: {
      starter: {
        ...
        monthlyPrice: '499',
        annualPrice: '5000',
        description: 'For virksomheder, der ønsker at komme i gang med real-time dokumentbehandling og dataudtrækning.',
        features: [
          'Udtræk fuld tekst til Markdown eller udtræk tabeller fra PDF/billede til CSV',
          '20k kreditter per måned, derefter $0.025 per kredit',
      ...
      silver: {
        ...
        features: [
          ...
          '100k kreditter per måned, derefter $0.015 per kredit',
      ...
      enterprise: {
        name: 'Enterprise',
        price: 'Kontakt os',
        description: 'For store organisationer, der kræver skræddersyede løsninger, dedikeret support og sikkerhed på virksomhedsniveau.',
        features: [
    ...
    disclaimers: {
      ...
      tokenExplanation: '** Sider, der overstiger 500 tokens, vil medføre en ekstra kredit for hver yderligere 500 tokens.'
    },
    specialOffer: {
      ...
      startupDetails: '(mindre end 10 personer)',
      orText: 'eller',
      nonprofitText: 'Non-profit organisationer.',
      emailText: 'Email',
      emailLink: 'info@cambioml.com',
      redeemText: 'for at indløse din kredit!'
    }
  },
  playground: {
    ...
    disclaimers: {
      ...
      fileSize: '**MAKSIMAL FILSTØRRELSE ER 10MB. Opdatering af denne side vil slette alle filer og behandlede data, da vi ikke gemmer dine data.',
      privacyPolicy: 'Se AnyParser privatlivspolitik.'
    },
    feedback: {
      button: 'Feedback',
      ...
      errorMessage: 'Kontakt mislykkedes. Prøv venligst igen.'
    },
    files: {
      title: 'Filer',
      uploadFile: 'Upload fil',
      pleaseUploadFile: 'Upload venligst en fil.',
    ...
    upload: {
      dragAndDrop: 'Træk og slip en enkelt fil her eller klik for at vælge en fil',
      dropFiles: 'Slip filer her',
      filesOnly: 'kun filer',
      maxSize: 'Maksimal størrelse 10MB',
      noSensitiveInfo: 'Upload venligst ikke nogen følsomme oplysninger.',
      fileTypeNotSupported: 'Filtypen understøttes ikke.',
      sizeLimitExceeded: 'Størrelsen overstiger grænsen på {limit}MB. Prøv venligst igen.'
    },
    uploadModal: {
      or: 'ELLER',
      pasteScreenshot: 'Indsæt et skærmbillede',
      uploading: 'Uploader'
    },
    keyValue: {
      ...
      undo: 'Fortryd',
      maxInputsAllowed: 'Maksimalt 10 inputs tilladt',
    ...
    info: {
      plainText: {
        ...
        description: 'Med AnyParser kan du udtrække indholdet fra dine rå, ustrukturerede data, såsom PDF\'er, TXT\'er og HTML-filer.',
        howTo: 'Når du har uploadet og valgt en fil, kør \'Plain Text\'-flowet, som vil udtrække indholdet af din fil og returnere det i Markdown-format.',
        nextSteps: 'Næste trin',
        nextStepsDescription: 'Du kan downloade den rå Markdown som en tekstfil eller downloade JSON fra eventuelle udtrukne tabeller'
      },
      table: {
        title: 'Kun tabel udtrækning',
        description: 'Med AnyParser kan du udtrække tabeller fra dine filer, udtrække specifikke nøgler fra dem og kortlægge det til din databaseskema.',
        step1: '1. Udtræk tabeller',
        step1Description: 'Først skal du udtrække tabellerne fra din fil. AnyParser vil udtrække alle tabeller til HTML-format.\n\nNår de er udtrukket, kan du downloade den rå HTML eller downloade alle tabeller til en Excel-fil.',
        step2: '2. Vælg tabeller til kortlægning',
        step2Description: 'Efter at have kørt tabeludtrækningen, vælg de tabeller, du gerne vil udtrække data fra.\n\nI denne sektion vil du også have mulighed for at forhåndsvise hver tabels HTML.',
        step3: '3. Kortlæg skema',
        step3Description: 'Når du har udtrukket og valgt tabellerne, kan du derefter tilføje de nøgler, du ønsker at udtrække. Hvis du ønsker at fjerne den kortlagte nøgle, klik på (X) i boksen. Hvis du ønsker at fjerne en Input-nøgle, kan du klikke på (X)-ikonet i dens boks.\n\nNår du har tilføjet nogle nøgler, kan du køre Kortlæg Skema-funktionen. Efter kortlægning kan du redigere nogen af de kortlagte nøgler ved at klikke på rediger blyant-ikonet.\n\nKlik på \'Kortlæg Skema\' igen vil kun genkøre Input-nøgler uden nogen Kortlagte nøgler. Hvis du ønsker at generere en ny kortlagt nøgle, kan du først fjerne den Kortlagte nøgle ved at klikke på X.',
        nextSteps: 'Næste trin',
        nextStepsDescription: 'Når du er tilfreds med outputtet, kan du trykke på download CSV eller JSON. Dette vil kun være aktiveret, hvis mindst én Input-nøgle har en ikke-tom Kortlagt nøgle.'
      },
      keyValuePair: {
        title: 'Udtræk nøgle-værdi par',
        description: 'Med AnyParser kan du identificere og udtrække strukturerede nøgle-værdi par fra dine rå, ustrukturerede data, såsom fakturaer, kontrakter eller formularer.',
        howTo: 'Når du har uploadet og valgt en fil, kør \'Key-Value Pair\'-flowet, som vil analysere din fil, identificere nøglefelter og udtrække deres tilsvarende værdier i et struktureret JSON-format.',
        nextSteps: 'Næste trin',
        nextStepsDescription: 'Du kan downloade de udtrukne nøgle-værdi par som en JSON-fil eller integrere direkte med din arbejdsgang via vores API for at automatisere yderligere behandling.'
      }
    },
  ...
  account: {
    ...
    profile: {
      title: 'Profil',
      errorLoading: 'Fejl ved indlæsning af brugerprofil',
      pleaseLogin: 'Log venligst ind.',
      welcome: 'Velkommen'
    },
    apiKey: {
    ...
    subscriptions: {
      title: 'Abonnementer',
      description: 'Se produkter eller ændr dit abonnement.',
      viewProducts: 'Se produkter'
    },
    documentation: 'Se AnyParser Dokumentation'
  },
  auth: {
    login: 'Log ind',
    logout: 'Log ud',
  ...
  blog: {
    ...
    checkBackSoon: 'Kom snart tilbage for opdateringer!',
    backTo: 'Tilbage til'
  },
  bookDemo: {
    title: 'Book en Demo',
