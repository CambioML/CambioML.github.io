export const da = {
  ...
  company: {
    ...
    getStarted: {
      ...
      description:
        'Slut dig til tusindvis af forskere og ingeniører, der fremskynder deres F&U-processer med Energent.ai.',
  ...
  playground: {
    ...
    disclaimers: {
      ...
      fileSize:
        '**MAKSIMAL FILSTØRRELSE ER 10MB. Opdatering af denne side vil slette alle filer og behandlede data, da vi ikke gemmer dine data.',
