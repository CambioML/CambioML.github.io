export const sv = {
  nav: {
    ...
    aiOgDescription: 'Förbättrar arbetsflöden från fält till kontor.',
    aiHr: 'AI HR',
    aiHrDescription: 'Hanterar repetitiva HR-arbetsflöden.',
    aiDataScientist: 'AI Data Scientist',
    aiDataDescription: 'Snabbar upp dataarbetsflöden i stor skala',
    securityWhitepaper: 'Säkerhetsdokument',
    securityDescription: 'Omfattande guide för säkerhet och efterlevnad.',
    deploymentOverview: 'Översikt över distribution',
    deploymentDescription: 'Krav för företagsdistribution.',
    awsDeployment: 'AWS-distribution',
    awsDescription: 'Guide för AWS VM-distribution.',
    azureDeployment: 'Azure-distribution',
    azureDescription: 'Guide för Azure VM-distribution.'
  },
  common: {
    language: 'Språk',
    english: 'Engelska',
  ...
  homepage: {
    hero: {
      ...
      description: '80% av OCR-användare är trötta på att underhålla klisterkod. Frigör din tid med oöverträffad noggrannhet, fullständig integritet och konfigurerbara alternativ såsom:',
      features: [
        'ta bort privat identitetsinformation,',
        'extrahera tabeller och diagram,',
        'behålla fotnoter och rubriker,'
      ],
      moreFeatures: 'och mycket mer!',
      tryFree: 'Prova GRATIS',
      getApi: 'Hämta API-åtkomst',
      ...
      steps: [
        {
          ...
          description: 'Klicka på \'Ladda upp fil\' för att enkelt dra och släppa dokumenten du vill parsa, eller klistra in en skärmdump från ditt urklipp. Vi har också tillhandahållit exempel på dokumentation för att hjälpa dig komma igång.'
        },
        {
          title: '02',
          subtitle: 'Redigera inställningar för parsing och integritet',
          description: 'AnyParser kategoriserar automatiskt olika typer av information, inklusive PII (Personligt Identifierbar Information), fotnoter, tabeller och mer. Exportera bara den data du behöver!'
        },
        {
          title: '03',
          subtitle: 'Exportera resultat till ditt system',
          description: 'Ladda ner din data i ditt föredragna format—oavsett om det är HTML, Excel, JSON eller ett databas-schema anpassat till ditt arbetsflöde.'
        }
      ]
    },
    banners: [
      {
        ...
        description: 'AnyParser-lekplatsen är enkel, snabb och intuitiv. Prova gränssnittet nu och ta en paus resten av dagen',
        actionLabel: 'Prova GRATIS'
      },
      {
        title: 'Bygg med AnyParser',
        description: 'AnyParser-lekplatsen är enkel, snabb och verkligen intuitiv, prova gränssnittet nu och ta en paus resten av dagen',
        actionLabel: 'Hämta API-åtkomst'
      }
    ]
  },
  reviews: {
    ...
    testimonials: [
      {
        text: '"Vi hade provat alla pdf-extraktionsverktyg och AnyParser gav oss de mest exakta resultaten."',
        author: 'Richard Song',
        position: 'VD - Epsilla'
      },
      {
      ...
      {
        text: '"Det är mycket bättre än andra verktyg! Våra dataanalytiker kan tredubbla sina resultat."',
        author: 'Jamal',
        position: 'VD - xtrategise'
      }
    ]
  },
  company: {
    ...
    getStarted: {
      ...
      description: 'Gå med tusentals forskare och ingenjörer som påskyndar sina FoU-processer med Energent.ai.',
      buttonText: 'Kom igång',
      docsButtonText: 'Läs dokumentationen'
    }
  },
  pricing: {
    billing: {
    ...
    realTimeApi: {
      title: 'Prissättning för realtids-API',
      description: 'Den snabbaste visionsspråkmodellen med realtidsrespons på cirka 0,5 till 5 sekunder per sida.'
    },
    plans: {
      starter: {
        name: 'Start',
        monthlyPrice: '499',
        annualPrice: '5000',
        description: 'För företag som vill komma igång med realtidsdokumentbearbetning och dataextraktion.',
        features: [
          'Extrahera fullständig text till Markdown eller extrahera tabeller från PDF/bild till CSV',
          '20k krediter per månad, därefter $0.025 per kredit',
          'Extrahera nyckelvärdepar till JSON',
      ...
      enterprise: {
        name: 'Enterprise',
        price: 'Kontakta oss',
        description: 'För stora organisationer som kräver skräddarsydda lösningar, dedikerat stöd och säkerhet i företagsklass.',
        features: [
    ...
    disclaimers: {
      noHiddenFees: '* Inga dolda avgifter; Månatlig betalning; 30 dagars pengarna-tillbaka-garanti.',
      tokenExplanation: '** Sidor som överstiger 500 tokens kommer att medföra en extra kredit för varje ytterligare 500 tokens.'
    },
    specialOffer: {
      title: '🎉 Specialerbjudande för startups och ideella organisationer! 🎉',
      getStart: 'Få',
      ...
      redeemText: 'för att lösa in din kredit!'
    }
  },
  playground: {
    title: 'AnyParser Sandbox',
    description: 'Den första LLM som snabbt och exakt extraherar fullständigt innehåll från PDF:er*, PPT:er och bilder**.',
    tabs: {
      plainText: 'Fullständigt innehåll',
      table: 'Endast tabell',
      keyValuePair: 'Extrahera nyckel-värde-par'
    },
    disclaimers: {
      pageLimit: '*För varje uppladdad fil bearbetar vi endast de första tio sidorna för bättre tillgänglighet.',
      fileSize: '**MAXIMAL FILSTORLEK ÄR 10MB. Uppdatering av denna sida kommer att rensa alla filer och bearbetad data eftersom vi inte lagrar din data.',
    ...
    feedback: {
      ...
      errorMessage: 'Kontakt misslyckades. Försök igen.'
    },
    files: {
      title: 'Filer',
      uploadFile: 'Ladda upp fil',
      pleaseUploadFile: 'Vänligen ladda upp en fil.',
    ...
    upload: {
      dragAndDrop: 'Dra och släpp en enskild fil här eller klicka för att välja en fil',
    ...
    uploadModal: {
      or: 'ELLER',
      pasteScreenshot: 'Klistra in en skärmdump',
    ...
    keyValue: {
      ...
      expandKeyDescription: 'Expandera nyckelbeskrivning',
      extract: 'Extrahera',
      extracting: 'Extraherar...',
      extractKeyValue: 'Extrahera nyckel-värde',
      extractKeyValuePairs: 'Extrahera nyckel-värde-par',
      yourKeys: 'Dina nycklar',
      inputRemoved: 'Inmatning borttagen',
      undo: 'Ångra',
      maxInputsAllowed: 'Maximalt 10 inmatningar tillåtna',
    ...
    info: {
      plainText: {
        ...
        description: 'Med AnyParser kan du extrahera innehåll från dina råa, ostrukturerade data, som PDF:er, TXT-filer och HTML-filer.',
        howTo: 'När du har laddat upp och valt en fil, kör \'Plain Text\'-flödet, som kommer att extrahera innehållet från din fil och returnera det i Markdown-format.',
        nextSteps: 'Nästa steg',
        nextStepsDescription: 'Du kan ladda ner den råa Markdown som en textfil, eller ladda ner JSON från alla extraherade tabeller'
      },
      table: {
        title: 'Endast tabellutdrag',
        description: 'Med AnyParser kan du extrahera tabeller från dina filer, extrahera specifika nycklar från dem och mappa det till din databasstruktur.',
        step1: '1. Extrahera tabeller',
        step1Description: 'Först måste du extrahera tabellerna från din fil. AnyParser kommer att extrahera alla tabeller till HTML-format.\n\nNär de har extraherats kan du ladda ner den råa HTML eller ladda ner alla tabeller till en Excel-fil.',
        step2: '2. Välj tabeller att mappa',
        step2Description: 'Efter att ha kört tabellutdraget, välj de tabeller som du vill extrahera data från.\n\nI denna sektion kommer du också att ha möjlighet att förhandsgranska varje tabells HTML.',
        step3: '3. Mappa struktur',
        step3Description: 'När du har extraherat och valt tabellerna kan du sedan lägga till de nycklar som du vill extrahera. Om du vill ta bort den mapade nyckeln, klicka på (X) i rutan. Om du vill ta bort en inmatningsnyckel kan du klicka på (X)-ikonen i dess ruta.\n\nNär du har lagt till några nycklar kan du köra funktionen Mappa struktur. Efter mappning kan du redigera någon av de mapade nycklarna genom att klicka på redigeringspennikonen.\n\nAtt klicka på \'Mappa struktur\' igen kommer endast att köra inmatningsnycklarna utan några mapade nycklar. Om du vill generera en ny mapad nyckel kan du först ta bort den mapade nyckeln genom att klicka på X.',
        nextSteps: 'Nästa steg',
        nextStepsDescription: 'När du är nöjd med resultatet kan du ladda ner CSV eller JSON. Detta kommer endast att aktiveras om minst en inmatningsnyckel har en icke-tom mapad nyckel.'
      },
      keyValuePair: {
        title: 'Extrahera nyckel-värde-par',
        description: 'Med AnyParser kan du identifiera och extrahera strukturerade nyckel-värde-par från dina råa, ostrukturerade data, som fakturor, kontrakt eller formulär.',
        howTo: 'När du har laddat upp och valt en fil, kör \'Key-Value Pair\'-flödet, som kommer att analysera din fil, identifiera nyckelfält och extrahera deras motsvarande värden i ett strukturerat JSON-format.',
        nextSteps: 'Nästa steg',
        nextStepsDescription: 'Du kan ladda ner de extraherade nyckel-värde-paren som en JSON-fil, eller integrera direkt med ditt arbetsflöde via vår API för att automatisera vidare bearbetning.'
      }
    },
  ...
  account: {
    ...
    profile: {
      title: 'Profil',
      errorLoading: 'Fel vid laddning av användarprofil',
      pleaseLogin: 'Vänligen logga in.',
      welcome: 'Välkommen'
    },
    apiKey: {
      title: 'AnyParser API-nyckel',
      gettingStarted: 'Kom igång med AnyParser',
      limitedTime: 'Begränsad tid!',
      freePages: 'Varje API kan extrahera upp till 100 sidor gratis!',
      note: 'Notera:',
      limitations: [
      ...
      sendingVerification: 'Skickar verifieringsmail...',
      maxKeysGenerated: 'Du har genererat maximalt antal API-nycklar',
      generateNew: 'Generera ny API-nyckel',
  ...
  notFound: {
    title: '404',
    subtitle: 'Oj! Den här sidan finns inte',
