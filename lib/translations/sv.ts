export const sv = {
  ...
  homepage: {
    ...
    banners: [
      ...
      },
      {
        ...
        description:
          'AnyParser-lekplatsen är enkel, snabb och verkligen intuitiv, prova gränssnittet nu och ta en paus resten av dagen',
  ...
  company: {
    ...
    investors: {
      title: 'Investerare i Energent.ai',
    },
    getStarted: {
  ...
  pricing: {
    ...
    disclaimers: {
      ...
      tokenExplanation:
        '** Sidor som överstiger 500 tokens kommer att medföra en extra kredit för varje ytterligare 500 tokens.',
    },
    specialOffer: {
  ...
  playground: {
    ...
    description:
      'Den första LLM som snabbt och exakt extraherar fullständigt innehåll från PDF:er*, PPT:er och bilder**.',
    tabs: {
    ...
    info: {
      ...
      keyValuePair: {
        ...
        description:
          'Med AnyParser kan du identifiera och extrahera strukturerade nyckel-värde-par från dina råa, ostrukturerade data, som fakturor, kontrakt eller formulär.',
        howTo:
          "När du har laddat upp och valt en fil, kör 'Key-Value Pair'-flödet, som kommer att analysera din fil, identifiera nyckelfält och extrahera deras motsvarande värden i ett strukturerat JSON-format.",
        nextSteps: 'Nästa steg',
        nextStepsDescription:
          'Du kan ladda ner de extraherade nyckel-värde-paren som en JSON-fil, eller integrera direkt med ditt arbetsflöde via vår API för att automatisera vidare bearbetning.',
      },
    },
  ...
  login: {
    title: 'Välkommen till CambioML',
    subtitle: 'Logga in på ditt konto',
    description: 'Få tillgång till din AnyParser API och verktyg för dokumentbearbetning',
    mobileDescription: 'Logga in för att få tillgång till AnyParser',
    brandName: 'CambioML',
    form: {
      email: {
        label: 'E-post',
    ...
    passwordStrength: {
      ...
      uppercase: 'Minst en versal',
      lowercase: 'Minst en gemen',
      symbol: 'Minst ett specialtecken',
    },
  },
} as const;
