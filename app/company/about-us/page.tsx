...
function FoundingTeam() {
  return (
    ...
    >
      <div className="container flex flex-col gap-6.25 text-center">
        <h2 className="text-5xl font-medium">
          <span className="bg-gradient">Founding Team</span>
        </h2>
    ...
    >
      <div className="container flex flex-col gap-8 text-center items-center">
        ...
        <div className="flex items-center gap-5">
          ...
          >
            <span className="bg-gradient">Get Started</span>
          </button>
          <button
          ...
          >
            <span className="bg-gradient">Read the documentation</span>
          </button>
        </div>
      </div>
    </section>
