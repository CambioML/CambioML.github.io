  ...
  return (
    <div className="x pb-10 w-full h-full flex flex-col justify-center items-center">
      ...
      <div className="h-[100px] p-8 rounded-xl w-screen-xl items-center justify-center">
        ...
        <ul>
          <li>
            ** 1 credit covers 1 page extraction up to 300 tokens (a normal A4 page). Pages exceeding 300 tokens  
            will incur an extra credit for every additional 300 tokens.
          </li>
        </ul>
      </div>
    </div>
